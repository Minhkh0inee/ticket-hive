...
export class CreateEventsTable1773501220590 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."seat_section_enum" AS ENUM('floor', 'balcony', 'vip', 'general')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "seat" ADD CONSTRAINT "FK_6f9180da82fbdeb46141993f679" FOREIGN KEY ("eventId") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "seat" DROP CONSTRAINT "FK_6f9180da82fbdeb46141993f679"`,
    );
    await queryRunner.query(
