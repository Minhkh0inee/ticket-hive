...
export class RefactorEventCategoryToRelation1774599002057 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "event" RENAME COLUMN "category" TO "categoryId"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."event_category_enum" RENAME TO "event_categoryid_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "event" DROP CONSTRAINT "FK_d44e52c4ca04619ef9b61a11982"`,
    );
    await queryRunner.query(`ALTER TABLE "event" DROP COLUMN "categoryId"`);
    await queryRunner.query(
      `ALTER TABLE "event" ADD "categoryId" "public"."event_categoryid_enum" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."event_categoryid_enum" RENAME TO "event_category_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event" RENAME COLUMN "categoryId" TO "category"`,
    );
  }
}
