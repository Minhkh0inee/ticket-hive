...
export class CreatePaymentTable1776782885118 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6f9180da82fbdeb46141993f67" ON "seat" ("eventId") `);
        await queryRunner.query(`CREATE INDEX "IDX_150b22121790781fc107c8bc1b" ON "event" ("eventDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_2b524dda39a0b8debe43131a7a" ON "event" ("tag") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_2b524dda39a0b8debe43131a7a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_150b22121790781fc107c8bc1b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6f9180da82fbdeb46141993f67"`);
